...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/lavka4ydes2020-svg/AlfredoVPN"
    const val APP_API_URL = "https://api.github.com/repos/lavka4ydes2020-svg/AlfredoVPN/releases"
    ...
    const val DNS_PROXY = "https://dns.cloudflare.com/dns-query"
